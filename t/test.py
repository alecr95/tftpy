...
class TestTftpyClasses(unittest.TestCase):
    ...
    def testTftpPacketRRQ(self):
        ...
        rrq.options = options
        rrq.encode()
        self.assertTrue(rrq.buffer != None, "Buffer populated")
        rrq.decode()
    ...
    def testTftpPacketWRQ(self):
        ...
        wrq.options = options
        wrq.encode()
        self.assertTrue(wrq.buffer != None, "Buffer populated")
        wrq.decode()
    ...
    def testTftpPacketDAT(self):
        ...
        dat.data = data
        dat.encode()
        self.assertTrue(dat.buffer != None, "Buffer populated")
        dat.decode()
    ...
    def testTftpPacketACK(self):
        ...
        ack.blocknumber = 6
        ack.encode()
        self.assertTrue(ack.buffer != None, "Buffer populated")
        ack.decode()
    ...
    def testTftpPacketERR(self):
        ...
        err.errorcode = 4
        err.encode()
        self.assertTrue(err.buffer != None, "Buffer populated")
        err.decode()
    ...
    def testTftpPacketOACK(self):
        ...
        oack.encode()
        self.assertTrue(oack.buffer != None, "Buffer populated")
        oack.decode()
